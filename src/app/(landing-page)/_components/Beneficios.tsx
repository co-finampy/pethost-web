...
export function Beneficios() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-6 mt-12 sm:mt-24">
      <h1 className="text-4xl sm:text-3xl md:text-4xl font-bold text-center mb-8 sm:mb-12 flex flex-col">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-12">
        {benefits.map((item, index) => (
          <div key={index} className=" p-4 sm:p-6 rounded-lg flex flex-col items-center text-center">
